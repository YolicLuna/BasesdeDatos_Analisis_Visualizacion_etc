...
#Se crea una consulta para contar los usuarios con el nombre de usuario user7, se imprime si el usuario existe o no.abs
    ...
    if exists:
        ...
        print("El usuario no existe")
#Se crea una consulta para verificar si el usuario user7 existe, se imprime si el usuario existe o no.