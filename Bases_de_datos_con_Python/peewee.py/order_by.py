...
if __name__ == "__main__":
    ...
    # Se realiza una consulta para obtener todos los usuarios ordenados por el nombre de usuario de forma ascendente
    try:
        users = User.select().where(User.username == "user1").get()
        print(users)
    # Se maneja la excepcion en caso de que no se encuentre el usuario
