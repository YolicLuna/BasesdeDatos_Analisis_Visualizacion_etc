...
if __name__ == "__main__":
    ...
    # Se usa el metodo User.select() para obtener todos los registros de la tabla, se recorre el resultado y se imprimen sus atibutos o campos
    #users = User.select() es equivalente a SELECT * FROM users
    users = User.select()
    for user in users:
         print(user.email)
