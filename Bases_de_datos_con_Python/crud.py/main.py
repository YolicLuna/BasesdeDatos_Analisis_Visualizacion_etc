...
# Se crea un decorador para limpiar la terminal antes y después de ejecutar una funcion
...
# Se crean la funcion para crear un nuevo usuario
@system_clear
...
# Se crea la funcion para listar todos los usuarios
@system_clear
...
# Se crea un decorador para verificar si un usuario existe
...
# Se crea la funcion para actualizar un usuario añadiendo los decoradores creados para limpiar la terminal y verificar si el usuario existe
@system_clear
@user_exists
...
# Se crea la función para eliminar un usuario
@system_clear
...
if __name__ == '__main__':
    ...
    try:
        ...
        with connect.cursor() as cursor:
            ...
            # Se crea un bucle while para mostrar rl menú de opciones
            while True:
...
si la opción es salir, se rompe el ciclo.'''
                ...
                # Se obtiene la función correspondiente a la opción seleccionada por el usuario o la función por defecto si la opción no es válida
